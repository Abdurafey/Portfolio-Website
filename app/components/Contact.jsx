...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "61c926bb-fe26-4929-bde7-a5dfaf20cb02");
        ...
        <div id='contact' className=' w-full px-[12%] py-10 scroll-mt-20
         bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
            ...
            <p className=' text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
                contact us now for your queries related our services mail us now or call now
            </p>
            ...
            <form onSubmit={onSubmit} className=' max-w-2xl mx-auto'>
                ...
                <textarea rows='6' placeholder='Enter your message' required id=""
